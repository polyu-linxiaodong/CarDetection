...
class EvalCallback():
    ...
    def get_map_txt(self, image_id, image, class_names, map_out_path):
        ...
        #---------------------------------------------------------#
        #   Convert the image to RGB to prevent errors during prediction.
        #   The code only supports RGB image prediction, all other types of images will be converted to RGB
        #---------------------------------------------------------#
        image       = cvtColor(image)
        
        #---------------------------------------------------------#
        #   Resize the original image, resize to the size with the short side of 600
        #---------------------------------------------------------#
        ...
        with torch.no_grad():
            ...
            #-------------------------------------------------------------#
            #   Use the classifier's prediction results to decode the proposal boxes and get the prediction boxes
            #-------------------------------------------------------------#
